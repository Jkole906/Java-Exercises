...
public class MorningExercises {
    ...
    */
    public int returnLastElementOfParam(int[] passedInArray) {
    	int i = passedInArray.length - 1;
        return passedInArray[i];
    }
    
    /*
    6. Here, a variable is defined within a block. How can we get the value of that outside of the block in 
    order to return it? There are a couple of different ways of doing this, what can you come up with?
    */
    ...
    /*
    7. What will the variable result be at the end of the method? Change the number in the logic expression so that it 
    returns true.
    */
