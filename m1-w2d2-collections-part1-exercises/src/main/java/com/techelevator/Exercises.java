...
public class Exercises
{
	...
	/*
	 ******** NOTES********* List<String>/* Note 1 * copyOfStringArray /* Note 2* =/* Note
	 * 3* new ArrayList <String>();/* Note 4
	 */
	/*
	 * so now we need to tell the list we just made "Take each of the elements in
	 * the array (called 'stringArray' here) and add each one to the list we named
	 * 'copyOfStringArray'. 'for' loops are the best way to do that. for(String
	 * currentListItem : stringArray) { copyOfStringArray.add (currentListItem);
	 * 
	 * } return copyOfStringArray; } // Note 1 - This is the command to say'We are
	 * going to make a new list of strings'. // Note 2 - this is the NAME of that
	 * LIST // Note 3 - "=" here means 'MAKE the list(like making a basket)' // Note
	 * 4 - this is the full command to actually create the list itself
	 */
...
//		List<String> copyOfIntArray = new ArrayList<String>();
//
//		for (int currentListItem : integerArray)
//		{
//			if (currentListItem % 2 != 0)
