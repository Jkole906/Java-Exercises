...
public class AfternoonExercises
{
	...
	/*
	 * 17 and If either of you is very stylish, 8 or more, then the result is 2
	 * (yes). With the exception that if either of you has style of 2 or less, then
	 * the result is 0 (no). Otherwise the result is 1 (maybe). dateFashion(5, 10) →
	 * 2 dateFashion(5, 2) → 0 dateFashion(5, 5) → 1
	 */
	...
	// The squirrels will play if it is between 60 and 90 and its not summer,
	// however, while it is summer they will play between 60 and 90.
	/*
	...
	// Craig, I need to go over this with you, please come find me when you see
	// this.
