...
public class Exercises
{
	...
	public String extraEnd(String str)
	{
		...
		String stringOne = str.substring(str.length() - 2, str.length());
	...
	public String right2(String str)
	{
		...
		String withoutFirstTwo = str.substring(0, str.length() - 2);
		return lastTwo + withoutFirstTwo;
	...
	public String theEnd(String str, boolean front)
	{
		if (!front)
		{
			...
			// .length()-1 Gives last index and on
		}
		// using !front for the if negates the need for an "else", because
		// the if is clearly true if it gets to this point with boolean IE,
		// check to see if booleans are false FIRST
	 ...
	 * string. The string may be any length, including 0. withouEnd2("Hello") →
	 * "ell" withouEnd2("abc") → "b" withouEnd2("ab") → ""
	 */
	public String withouEnd2(String str)
	{
		...
		// get the value of index 1 and everything past it, which is nothing.
		return str;
	}
	...
	{
		// Oder of operations, note the (( and )) that define the order
	...
	{
		if (str.substring(0, 5).contains("bad"))
		{
			return true;
		}
		else
	...
	{
		int firstX = str.indexOf('x'); // not the ' ' to show it is a single char
	...
	public String stringBits(String str)
	{
		...
		{
			result += str.charAt(i); // same as result= result+str.charAt(i);
